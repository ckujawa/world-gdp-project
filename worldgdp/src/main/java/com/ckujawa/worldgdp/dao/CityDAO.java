...
import com.ckujawa.worldgdp.dao.mapper.CityRowMapper;
...
public class CityDAO {
	...
	public City getCityDetail(Long cityId) {
		...
		return namedParamJdbcTemplate.queryForObject("SELECT id, name, countrycode, "+ 
		"district, population FROM city WHERE " + 
		"id = :id", params, new CityRowMapper());
	}
