...
import com.ckujawa.worldgdp.dao.mapper.CountryLanguageRowMapper;
...
public class CountryLanguageDAO {
	...
	public void addLanguage(String countryCode, CountryLanguage language) {
		namedParamJdbcTemplate.update("INSERT INTO countrylanguage (" +
			"countrycode, language, isofficial, percentage )" +
			" VALUES (:country_code, :language, :is_official, :percentage)",
			getAsMap(countryCode, language));
	}
	...
	public boolean languageExists(String countryCode, String language) {
		...
		Integer count = namedParamJdbcTemplate.queryForObject("SELECT count(*) FROM countrylanguage " +
		" WHERE countrycode = :code AND language = :lang", params, Integer.class);
	...
	public void deleteLanguage(String countryCode, String language) {
		...
		namedParamJdbcTemplate.update("DELETE FROM countrylanguage " +
			"WHERE countrycode = :code AND language = :lang", params);
	}
	
	private Map<String, Object> getAsMap(String cc, CountryLanguage cl){
